...
<body>
 ...
 <section class="first-wall-text">
  ...
  <section class="colored-section" id="recipes">
    ...
    <h2 class="recipe">Quick & Easy Recipes!</h2>
    <h5 class="recipe-short-message">Simplify your culinary adventures with our collection of quick and easy-to-make recipes, turning every meal into a delightful experience that's both efficient and delicious</h5>
      ...
      <div class="more">
        ...
        <div class="row">
          ...
          <div class="more-box col-lg-4 zoomable-div">
            <a class="recipe-links" href=""><img class="imge" src="images/Quick&Easy/quick001.jpg" alt=""></a>
            <a class="recipe-links " href=""><h3 class="recipe-name-white">Chicken Sandwitch</h3></a>
            <p class="more-p">Spicy Chicken Sandwich with cheese.</p>
          </div>
        </div>
      </div>
    </div>     
