...
<body>
   ...
   <!-- Recipes -->
 <main class="content pork">



  <section class="colored-section" id="recipes">

    <h2 class="recipe">Pork Recipes</h2>
      ...
      <div class="more">
        ...
        <div class="row">
          ...
          <div class="more-box col-lg-4 zoomable-div">
            <a class="recipe-links" href=""><img class="imge" src="images/coming_soon.jpg" alt=""></a>
            <a class="recipe-links" href=""><h3></h3></a>
            <p class="more-p">
          </div>
