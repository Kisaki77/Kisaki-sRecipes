...
<body>
  ...
  <div id="header-container">
    ...
    <div class="navbar-recipe-page  sticky-nav menu" id="container-fluid">
        <!-- Nav Bar -->
    ...
    <div class="mobile-nav">
      <ul class="sidebar-menu">
        <form class="mobile-search-container search-box form-inline">
          <input type="text" placeholder="What are you lookng for?" class="search mobile-nav-search" id="searchBar" name="searchBar">
        </form>
        ...
        <li><a class="mobile-nav-link" href="contact.php">Contact</a></li>
